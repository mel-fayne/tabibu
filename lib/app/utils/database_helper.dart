...
class DatabaseHelper {
  ...
  void _createDb(Database db, int newVersion) async {
    await db.execute(
        'CREATE TABLE $diagnosisTable($colDiagnosisid INTEGER PRIMARY KEY AUTOINCREMENT, $colPatientid INTEGER, '
        '$colDisease TEXT, $colDescription LONGTEXT, $colDiagnosisdate VARCHAR, $colWeight INTEGER, $colTemperature INTEGER, $colBloodpressure INTEGER, $colPulserate INTEGER, $colSymptoms LONGTEXT, $colMedicine TEXT, $colPrescription TEXT, $colAdditionaltreatmentinfo LONGTEXT)');
  }
