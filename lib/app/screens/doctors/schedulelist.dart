...
class ScheduleList extends StatefulWidget {
  ...
  ScheduleList({@required this.drid});
  @override
  State<StatefulWidget> createState() {
    return ScheduleListState(this.drid);
  }
}
...
class ScheduleListState extends State<ScheduleList> {
  ...
  getUnconfAppt() async {
    var url = "http://192.168.0.15/tabibu/api/doctors/getunconfappt.php";
  ...
  getConfAppt() async {
    var url = "http://192.168.0.15/tabibu/api/doctors/getconfirmedappt.php";
    var res = await http.post(url,
        body: {"doctorid": drid}, headers: {"Accept": "application/json"});
  ...
  getDoneAppt() async {
    var url = "http://192.168.0.15/tabibu/api/doctors/getdoneappt.php";
    var res = await http.post(url,
        body: {"doctorid": drid}, headers: {"Accept": "application/json"});
